...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('event_users', function (Blueprint $table) {
            ...
            if (! SchemaGuard::hasIndex('event_users', 'idx_event_users_attendee_event_lookup')) {
        ...
        Schema::table('fursuits', function (Blueprint $table) {
            ...
            if (! SchemaGuard::hasIndex('fursuits', 'idx_fursuits_gallery_base_filter')) {
            ...
            if (! SchemaGuard::hasIndex('fursuits', 'idx_fursuits_event_status_published')) {
            ...
            if (! SchemaGuard::hasIndex('fursuits', 'idx_fursuits_name_search_sort')) {
        ...
        Schema::table('transactions', function (Blueprint $table) {
            ...
            if (! SchemaGuard::hasIndex('transactions', 'idx_transactions_amount_filter')) {
        ...
        Schema::table('events', function (Blueprint $table) {
            ...
            if (! SchemaGuard::hasIndex('events', 'idx_events_starts_at_sorting')) {
        ...
        Schema::table('badges', function (Blueprint $table) {
            ...
            if (! SchemaGuard::hasIndex('badges', 'idx_badges_fursuit_status')) {
