 ...
 * Fursuits.
 *
 * Unchanged from the old panel on purpose. Two points are load-bearing for the
 * /admin rebuild and are written down here rather than rediscovered:
 *
 *  - `create()` stays false. It is not a bug to fix during a rewrite: fursuits come from the attendee ordering flow, never from staff. No create
 ...
 *    the old panel page, whose header actions carried no authorization beyond the resource's
 *    view check.
 */
class FursuitPolicy
{
