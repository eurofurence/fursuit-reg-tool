 ...
 *
 * The rules are the old machine list's form schema: four fields, nothing else.
 ...
 *
 * The two foreign keys are validated against their tables. the old panel's Select carried the
...
class MachineRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            // the old panel's Checkbox: present and boolean. `required` accepts false, which
    ...
    /**
     * the old panel's own labels, so a validation message names the field the way the form
     * does.
     *
