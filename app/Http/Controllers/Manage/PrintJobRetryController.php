...
/**
 * The one endpoint in this module that puts a card back through a printer.
 *
 ...
 * behaviour today and a recorded gap: a retried card does not start printing
...
class PrintJobRetryController extends Controller
{
    public function store(PrintJob $printJob): RedirectResponse
    {
        ...
        // the old print-job list's own notification, verbatim: success, title only, no body.
