<script setup>
/**
 * The print-job list, successor to PrintJobResource's table and its ListPrintJobs page.
 *
 ...
 * the single free values Filament rendered as TextInputs inside a filter form, used to be
...
// PrintJobResource polls this table every 5 seconds (audit 7.1). Only the data props are
