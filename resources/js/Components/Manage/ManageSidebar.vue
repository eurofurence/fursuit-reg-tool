<script setup>
/**
 * Permanent left sidebar. Always 220px, always labelled, no collapse.
 *
...
<template>
  <nav
    class="flex w-[220px] shrink-0 flex-col overflow-y-auto border-r border-hairline bg-mg-surface-1"
